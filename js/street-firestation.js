...
(() => {
  ...
  // This station predates the road shell's later named section datums. Keep the two frontage
  // measurements local so the station can be deployed safely against either road layout: the
  // west kerb is the public-route boundary, and the cycle conflict ends at the turnout table.
  const KERB_X = 25.42, CYCLE_X1 = 27.67;
  ...
  StreetFit['firestation'] = S => {
    ...
    flat((FACE + KERB_X) / 2, .015, -14.825, KERB_X - FACE, 4.05, RENDER2,
    ...
    const turnoutX0 = KERB_X, turnoutX1 = CYCLE_X1, turnoutZ = BAY_CENTRES[2];
    ...
    S.FIRE_ZONE = {
      id: 'fire-station-front', x0: FACE, x1: KERB_X,
